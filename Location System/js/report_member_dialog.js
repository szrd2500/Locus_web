    ...
    setDialog = {
        inputMembers: function () {
            var dialog,
                ...
                addMemberRow = function (item, data) {
            ...
            $("#btn_search_member").on("click", function () {
                var result = memberList,
                    ...
                    membersFilter = function (list, condition, null_str) {
                        var temp = {};
            ...
            var jxh = createJsonXmlHttp("sql"); //getMemberList
        ...
        displayRows: function () {
            var dialog,
                inputRowsTable = function () {
                    var createTbody = function (checkbox_name, type) {
                        var html = "",
                            count_row = 0,
