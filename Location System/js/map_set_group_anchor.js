var GroupAnchorFunc = {
    edit: function (anchor_id, set_x, set_y) {
        if (anchor_id == "")
            return;
        var anchor_groupList = GetRowsDatas.groupAnchor();
        var count = 0;
        ...
        $("#edit_group_anchor").html(GroupListFunc.Get.anchorDropdown(anchor_id)).prop("disabled", true);
                    ...
                    if (checkTokenAlive(revObj) && revObj.Value[0].success > 0) {
                        ...
                        group_anchors.forEach(function (info, i) {
                            ...
                            $("#table_anchor_group tbody").append("<tr id=\"" + tr_id + "\"><td>" +
                                ...
                                " onclick=\"GroupAnchorFunc.edit(\'" + info.anchor_id + "\',\'" + info.set_x + "\',\'" +
                                info.set_y + "\')\" />" +
                                "</td></tr>");
                            inputAnchorArray({
                                id: info.anchor_id,
        ...
        add: function () {
            var dialog, form,
                ...
                SendResult = function () {
                    ...
                    var valid = true;
                    var GroupAnchorList = GetRowsDatas.groupAnchor(); //驗證新增的Group與Anchor關聯是否重複
            ...
            $("#btn_add_anchor_group").on("click", function () {
                ...
                GroupListFunc.bindChange("#add_group_id", "#add_group_name");
                dialog.dialog("open");
            });

            $("#btn_pos_anchor_group").on("click", startAnchorPosition);
            ...
            $("#btn_delete_anchor_group").on("click", function () {
                if (confirm($.i18n.prop('i_mapAlert_20'))) {
                    ...
                    if (deleteArr.length > 0)
                        GroupAnchorFunc.Request.delete(deleteArr);
                    else
            ...
            $("#btn_edit_group_add").on("click", function () {
                ...
                GroupListFunc.bindChange("select[name='edit_group_id']", "select[name='edit_group_name']");
            });
                ...
                SendResult = function () {
                    ...
                    if (valid) {
                        if (edit_anchor.prop("disabled")) { //disabled==>edit mode
                            ...
                            var GroupAnchorList = GetRowsDatas.groupAnchor();
